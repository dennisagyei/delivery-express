...
module.exports = {
    ...
    'facebookAuth' : {
        ...
        'callbackURL'   : 'https://delivery-express-dennisagyei.c9users.io/auth/facebook/callback'
    },
    ...
    'googleAuth' : {
        ...
        'callbackURL'   : 'https://delivery-express-dennisagyei.c9users.io/auth/google/callback'
    }
